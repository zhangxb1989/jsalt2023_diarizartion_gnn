...
parser.add_argument("--p_model_filename", type=str, default="p_lander.pth")
...
p_checkpoint_path = args.p_model_filename
if os.path.exists(p_checkpoint_path):
    # Load the checkpoint
    checkpoint = torch.load(p_checkpoint_path)
